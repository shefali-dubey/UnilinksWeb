...
public class Alumnus	{	
	 ...
	 */
	/*public void Alumnus(String firstName, String lastName, String orgName, String universityName) {
	...
	/**
	 * This method gets the list of all alumni of specified school from database.
	 * @param schoolName
	 * @return
	 */
	public static List<Alumnus> getAlumni(String schoolName) {
		...
		if (MorphiaObject.datastore != null){
			...
			DBCursor cursor = MorphiaObject.datastore.getCollection(Alumnus.class).find(getObject);
